...
export const tradeKeys = {
  all: ["trade"] as const,
  status: (tradeId: TradeId) => [...tradeKeys.all, "status", tradeId] as const,
...
/** 거래 상태 조회 */
export function useTradeStatus(tradeId: TradeId | undefined) {
  return useQuery({
...
export function useCancelTrade() {
  ...
  return useMutation({
    mutationFn: (tradeId: TradeId) => tradeApi.cancelTrade(tradeId),
...
export type { TradeId, TransactionRequest, TradeResponse, TradeHistoryResponse };
